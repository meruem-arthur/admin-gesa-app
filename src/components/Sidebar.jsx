        ...
        <aside style={{ ...s.sidebar, ...(isMobile ? s.sidebarMobile : {}) }}>
          <div style={s.logoRow}>
            <div style={s.logoImgWrap}>
              <img src={LOGO_URL} alt="GESA" style={s.logoImg} onError={e => { e.target.style.display = 'none' }} />
...
const s = {
  sidebar: {
    ...
    padding: '24px 12px', flexShrink: 0, zIndex: 100,
  },
  sidebarMobile: {
  ...
  hamburger: {
    ...
    background: 'rgba(23,19,46,0.9)', backdropFilter: 'blur(8px)',
    border: '1px solid rgba(212,160,23,0.3)',
    color: '#e8b82a', fontSize: 18, cursor: 'pointer',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
  },
  backdrop: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.55)', zIndex: 150 },
  closeBtn: { marginLeft: 'auto', background: 'transparent', border: 'none', color: '#9b8ec0', fontSize: 16, cursor: 'pointer', padding: 4 },
  logoRow: {
  ...
  logoImgWrap: {
    ...
    border: '2px solid rgba(212,160,23,0.4)', backgroundColor: '#5b21b6',
    flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative',
  },
  logoImg:      { width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', top: 0, left: 0 },
  logoFallback: { fontSize: 11, fontWeight: 800, color: '#fff', zIndex: 1 },
  ...
  linkActive: { background: 'rgba(212,160,23,0.1)', color: '#e8b82a', fontWeight: 600 },
